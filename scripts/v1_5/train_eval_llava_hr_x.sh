...
deepspeed llava_hr/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-hr-x-7b-pretrain-384 \
    --num_train_epochs 1 \
...
deepspeed llava_hr/train/train_mem.py \
    ...
    --vision_tower openai/clip-vit-large-patch14-336 \
    --vision_tower_slow convnext_xxlarge.clip_laion2b_soup \
    --pretrain_mm_mlp_adapter ./checkpoints/llava-hr-x-7b-pretrain-384/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-hr-x-7b-sft-768 \
    --num_train_epochs 1 \
...
bash scripts/v1_5/eval.sh ./checkpoints/llava-hr-x-7b-sft-768 2>&1 | tee log-llava-hr-x-7b-sft-768.txt