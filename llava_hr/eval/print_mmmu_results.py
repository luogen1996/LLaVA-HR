...
from llava_hr.eval.mmmu_utils.data_utils import CAT_SHORT2LONG, DOMAIN_CAT2SUB_CAT

from llava_hr.eval.mmmu_utils.eval_utils import calculate_ins_level_acc
