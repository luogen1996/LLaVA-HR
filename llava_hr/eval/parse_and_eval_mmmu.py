...
from llava_hr.eval.mmmu_utils.data_utils import save_json, CAT_SHORT2LONG
from llava_hr.eval.mmmu_utils.eval_utils import evaluate, parse_multi_choice_response, parse_open_response
